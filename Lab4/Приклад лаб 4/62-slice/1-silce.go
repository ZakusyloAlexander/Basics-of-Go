...
func main() {
	...
	part1 := fourth[:2] // ссылки на тот же массив, что и fourth
	part2 := fourth[2:4]
	part3 := fourth[4:]
	part4 := fourth[:]
	...
	fmt.Println("\nfourth = ", fourth) // fourth = [100 2 300 4 500 6]
	fmt.Println("part4  = ", part4)    // part4  = [100 2 300 4 500 6]

	copyOfFourth := make([]int, 6) // Копирование среза
	count := copy(copyOfFourth, fourth)
	fourth = []int{1, 2, 3, 4, 5, 6}

	fmt.Println("\nfourth        = ", fourth)     // fourth        = [1 2 3 4 5 6]
	...
	fmt.Println("\nfourth        = ", fourth)     // fourth        = [1 2 3 4 5 6 100 2 300]
	fmt.Println("copyOfFourth  = ", copyOfFourth) // copyOfFourth  = [100 2 300 4 500 6]

	fourth = append(fourth, 111, 222, 333)
	fmt.Println("\nfourth        = ", fourth) // fourth        = [1 2 3 4 5 6 100 2 300 111 222 333]
